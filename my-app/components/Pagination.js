...
export default function Pagination() {
  ...
  return (
    <nav className="w-11/12 px-4 flex items-center justify-between sm:px-0">
      <div className="w-0 flex-1 flex mt-2">
        {ctx.page > 1 && (
          <a
            ...
            className="inline-flex items-center px-8 py-2 border border-transparent text-sm font-medium rounded-md text-orange-600 hover:text-orange-800 bg-orange-100 hover:bg-orange-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
          >
            Previous
          </a>
        )}
      ...
      <div className="-mt-px w-0 flex-1 mt-2 flex justify-end">
